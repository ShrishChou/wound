...
public class LauncherActivity extends AppCompatActivity {
    ...
    private static final String ORCHESTRATOR_APP_ENTRY = ".history.OrchestratorActivity";
    ...
    private static final String WOUND_VISIBLE_ACTIVITY =
            WOUND_VISIBLE_IMAGE_PKG + ORCHESTRATOR_APP_ENTRY;
...
//                WOUND_VISIBLE_REQ_CODE, visibleParams);
        findViewById(R.id.woundVisibleImageBtn).setOnClickListener(v -> {
            startActivityForResult(new Intent(this, OrchestratorActivity.class),
                    WOUND_VISIBLE_REQ_CODE);
        });
...
//                WOUND_THERMAL_REQ_CODE, thermalParams);
    ...
    private void setOnClickListenerForMeasurements(int widgetId, final String packageName,
        ...
        measurementBtn.setOnClickListener(v -> {
            ...
            it.putExtras(extras);
            try {
                /// switches to other app
                if(requestCode == WOUND_VISIBLE_REQ_CODE)
                {
                    toast(this, "visible app!");
